...
const BRAND = 'Progenesis';
const THEME_DARK = 'Progenesis Dark';
const THEME_LIGHT = 'Progenesis Light';
const CONFIG_NS = 'progenesisTheme';
const VIEW_ID = 'progenesisThemePalette';
...
const ICON_THEME = 'progenesis-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Progenesis Dark","short":"Dark"},"light":{"label":"Progenesis Light","short":"Light"}}];
