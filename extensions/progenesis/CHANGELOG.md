...
- Brand colours sourced from the official Progenesis brand palette.
...
- Progenesis brand mark as the activity-bar icon.
...
- Add white background to icon for better visibility in marketplace

## 1.0.1

### Bug Fixes

- Fix icon aspect ratio with proper padding for square display

## 1.0.0 (Initial Release)

### Features

- Dark theme with teal keywords and navy backgrounds
- Light theme with dark blue accents and cool white backgrounds
