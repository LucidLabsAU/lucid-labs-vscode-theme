...
const BRAND = 'Banjo Loans';
const THEME_DARK = 'Banjo Dark';
const THEME_LIGHT = 'Banjo Light';
const CONFIG_NS = 'banjoLoansTheme';
const VIEW_ID = 'banjoLoansThemePalette';
...
const ICON_THEME = 'banjo-loans-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Banjo Dark","short":"Dark"},"light":{"label":"Banjo Light","short":"Light"}}];
