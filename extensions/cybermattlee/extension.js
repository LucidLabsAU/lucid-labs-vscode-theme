...
const BRAND = 'CyberMattLee';
const THEME_DARK = 'Matt Lee Full Beard';
const THEME_LIGHT = 'Matt Lee Shaved';
const CONFIG_NS = 'cybermattleeTheme';
const VIEW_ID = 'cybermattleeThemePalette';
...
const ICON_THEME = 'cybermattlee-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Matt Lee Full Beard","short":"Full Beard"},"light":{"label":"Matt Lee Shaved","short":"Shaved"}}];
