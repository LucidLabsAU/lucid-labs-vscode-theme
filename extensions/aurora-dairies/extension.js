...
const BRAND = 'Aurora Dairies';
const THEME_DARK = 'Aurora Dairies Dark';
const THEME_LIGHT = 'Aurora Dairies Light';
const CONFIG_NS = 'auroraDairiesTheme';
const VIEW_ID = 'auroraDairiesThemePalette';
...
const ICON_THEME = 'aurora-dairies-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Aurora Dairies Dark","short":"Dark"},"light":{"label":"Aurora Dairies Light","short":"Light"}}];
