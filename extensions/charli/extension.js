...
const BRAND = 'CHARLI Health';
const THEME_DARK = 'CHARLI Dark';
const THEME_LIGHT = 'CHARLI Light';
const CONFIG_NS = 'charliTheme';
const VIEW_ID = 'charliThemePalette';
...
const ICON_THEME = 'charli-health-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"CHARLI Dark","short":"Dark"},"light":{"label":"CHARLI Light","short":"Light"}}];
