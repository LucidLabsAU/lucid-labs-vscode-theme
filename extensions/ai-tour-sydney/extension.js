...
const BRAND = 'AI Tour Sydney';
const THEME_DARK = 'AI Tour Sydney Dark';
const THEME_LIGHT = 'AI Tour Sydney Light';
const CONFIG_NS = 'aiTourSydneyTheme';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"AI Tour Sydney Dark","short":"Dark"},"light":{"label":"AI Tour Sydney Light","short":"Light"}}];
