...
const BRAND = 'Queensland Parks & Wildlife (Unofficial)';
const THEME_DARK = 'Queensland Parks & Wildlife Dark';
const THEME_LIGHT = 'Queensland Parks & Wildlife Light';
const CONFIG_NS = 'qpwsTheme';
const VIEW_ID = 'qpwsThemePalette';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Queensland Parks & Wildlife Dark","short":"Dark"},"light":{"label":"Queensland Parks & Wildlife Light","short":"Light"}}];
