...
const ICON_THEME = 'lucid-labs-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Lucid Labs Dark","short":"Dark"},"light":{"label":"Lucid Labs Light","short":"Light"}}];
...
const MCP_CONFIG = {"id":"lucidOperations","label":"Lucid Operations","url":"https://mcp.lucidlabs.com.au/mcp"};
