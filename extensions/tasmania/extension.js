...
const BRAND = 'Tasmania';
const THEME_DARK = 'Tasmania Dark';
const THEME_LIGHT = 'Tasmania Light';
const CONFIG_NS = 'tasmaniaTheme';
const VIEW_ID = 'tasmaniaThemePalette';
...
const ICON_THEME = 'tasmania-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Tasmania Dark","short":"Dark"},"light":{"label":"Tasmania Light","short":"Light"}}];
