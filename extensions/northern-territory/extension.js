...
const BRAND = 'Northern Territory';
const THEME_DARK = 'Northern Territory Dark';
const THEME_LIGHT = 'Northern Territory Light';
const CONFIG_NS = 'northernTerritoryTheme';
const VIEW_ID = 'northernTerritoryThemePalette';
...
const ICON_THEME = 'northern-territory-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Northern Territory Dark","short":"Dark"},"light":{"label":"Northern Territory Light","short":"Light"}}];
