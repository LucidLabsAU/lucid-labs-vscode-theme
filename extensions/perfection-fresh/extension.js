...
const BRAND = 'Perfection Fresh';
const THEME_DARK = 'Perfection Dark';
const THEME_LIGHT = 'Perfection Light';
...
const ICON_THEME = 'perfection-fresh-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Perfection Dark","short":"Dark"},"light":{"label":"Perfection Light","short":"Light"}}];
