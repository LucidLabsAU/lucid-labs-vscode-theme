...
const BRAND = 'Asplundh';
const THEME_DARK = 'Asplundh Dark';
const THEME_LIGHT = 'Asplundh Light';
const CONFIG_NS = 'asplundhTheme';
const VIEW_ID = 'asplundhThemePalette';
...
const ICON_THEME = 'asplundh-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Asplundh Dark","short":"Dark"},"light":{"label":"Asplundh Light","short":"Light"}}];
