...
const BRAND = 'South Australia';
const THEME_DARK = 'South Australia Dark';
const THEME_LIGHT = 'South Australia Light';
const CONFIG_NS = 'southAustraliaTheme';
const VIEW_ID = 'southAustraliaThemePalette';
...
const ICON_THEME = 'south-australia-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"South Australia Dark","short":"Dark"},"light":{"label":"South Australia Light","short":"Light"}}];
