...
const BRAND = 'Australian Food & Fibre';
const THEME_DARK = 'AFF Dark';
const THEME_LIGHT = 'AFF Light';
const CONFIG_NS = 'australianFoodFibreTheme';
const VIEW_ID = 'australianFoodFibreThemePalette';
...
const ICON_THEME = 'australian-food-fibre-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"AFF Dark","short":"Dark"},"light":{"label":"AFF Light","short":"Light"}}];
