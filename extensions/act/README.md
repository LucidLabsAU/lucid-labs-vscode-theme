...
A professional VS Code colour theme featuring the Australian Capital Territory's
iconic blue and gold colour palette.

## Features

- **Blue & Gold Palette** — ACT's signature colours throughout the editor
...
|--------|----------|-------|
| **ACT Blue** | `#003087` | Primary accent, functions, links |
| **ACT Gold** | `#FFCD00` | Keywords, highlights |
