...
const BRAND = 'New South Wales';
const THEME_DARK = 'New South Wales Dark';
const THEME_LIGHT = 'New South Wales Light';
const CONFIG_NS = 'newSouthWalesTheme';
const VIEW_ID = 'newSouthWalesThemePalette';
...
const ICON_THEME = 'new-south-wales-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"New South Wales Dark","short":"Dark"},"light":{"label":"New South Wales Light","short":"Light"}}];
