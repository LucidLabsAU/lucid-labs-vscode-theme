...
const BRAND = 'Icon Group';
const THEME_DARK = 'Icon Group Dark';
const THEME_LIGHT = 'Icon Group Light';
const CONFIG_NS = 'iconGroupTheme';
const VIEW_ID = 'iconGroupThemePalette';
...
const ICON_THEME = 'icon-group-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Icon Group Dark","short":"Dark"},"light":{"label":"Icon Group Light","short":"Light"}}];
