...
const BRAND = 'Victoria';
const THEME_DARK = 'Victoria Dark';
const THEME_LIGHT = 'Victoria Light';
const CONFIG_NS = 'victoriaTheme';
const VIEW_ID = 'victoriaThemePalette';
...
const ICON_THEME = 'victoria-icons';
...
const THEMES = [{"edition":"Everyday","dark":{"label":"Victoria Dark","short":"Dark"},"light":{"label":"Victoria Light","short":"Light"}}];
