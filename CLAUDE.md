...
|-------|-------------|---------|
| Lucid Labs | `lucidlabs.lucid-labs-theme` | 1.10.0 |
| CHARLi | `lucidlabs.charli-health-theme` | 1.6.0 |
| Perfection Fresh | `lucidlabs.perfection-fresh-theme` | 1.5.0 |
| Australian Food & Fibre | `lucidlabs.australian-food-fibre-theme` | 1.5.0 |
| Banjo Loans | `lucidlabs.banjo-loans-theme` | 1.5.0 |
| Progenesis | `lucidlabs.progenesis-theme` | 1.5.0 |
| Icon Group | `lucidlabs.icon-group-theme` | 1.6.0 |
| Queensland | `lucidlabs.queensland-theme` | 1.5.0 |
| New South Wales | `lucidlabs.new-south-wales-theme` | 1.4.0 |
| Victoria | `lucidlabs.victoria-theme` | 1.4.0 |
| Tasmania | `lucidlabs.tasmania-theme` | 1.4.0 |
| South Australia | `lucidlabs.south-australia-theme` | 1.4.0 |
| Western Australia | `lucidlabs.western-australia-theme` | 1.4.0 |
| Northern Territory | `lucidlabs.northern-territory-theme` | 1.4.0 |
| ACT | `lucidlabs.act-theme` | 1.4.0 |
...
- **Templates**: `templates/base-*.jsonc` — 896 UI colour keys (100% VS Code API coverage), 55 tokenColor entries, 15 semantic tokens with `{{role}}` placeholders
